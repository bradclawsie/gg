...
CREATE TABLE IF NOT EXISTS org (
    ...
    -- `role` == 1 is constant `model.RoleNormal`.
    -- `role` == 2 is constant `model.RoleAdmin`.
    -- `role` == 3 is constant `model.RoleTest`.
    ...
    -- `status` == 1 is constant `model.StatusUnconfirmed`.
    -- `status` == 2 is constant `model.StatusActive`.
    -- `status` == 3 is constant `model.StatusInactive`.
